                ...
                rules: [
                  {
                    ...
                    message: intl
                      ...
                      .d(`${field[fieldLabelProp]}不能为空`),
                  },
                ],
              })(
                <ComponentType
                  {...componentProps}
                  disabled={field.props.disabled || field.enabledFlag !== 1} // 先判断字段属性上的 disabled 后判断 enabledFlag
                />
              )}
            </FormItem>
          }
    ...
    return new Promise((resolve, reject) => {
      form.validateFields((err, data) => {
        if (!err) {
          ...
          const { dataSource = {} } = this.state;
          const submitData = Object.assign({}, dataSource, data);
          if (submitUrl) {
            // 通过
  ...
  getFormData() {
    return new Promise((resolve, reject) => {
      ...
      form.validateFields((err, fieldsValue) => {
        ...
        resolve(Object.assign({}, dataSource, fieldsValue));
      });
    });
  }
}
...
DynamicForm.exportFuncsInfo = {
  submit: {
    ...
    descriptionIntlDefault: '提交',
  },
  reset: {
    descriptionIntlCode: 'hpfm.ui.tpl.form.reset',
    descriptionIntlDefault: '重置',
  },
};
