...
import { isFunction, map, forEach, findIndex, omit, filter } from 'lodash';
...
import { getWidthFromWord, getDisplayValue } from '../utils';
...
function getComputeTableProps(props) {
  const { onRowEdit, fields, editable, addable, context } = props;
  // let index = 0;
  let columnsWidth = 0;
