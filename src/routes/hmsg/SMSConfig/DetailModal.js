        ...
        <Form>
              ...
              rules: [
                {
                  required: true,
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get('hmsg.smsConfig.model.smsConfig.serverCode').d('账户代码'),
                  }),
                },
              ],
              ...
              rules: [
                {
                  required: true,
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get('hmsg.smsConfig.model.smsConfig.serverName').d('账户名称'),
                  }),
                },
              ],
          ...
          >
            {getFieldDecorator('signName', {
              ...
              initialValue: tableRecord.signName ? tableRecord.signName : '',
            })(<Input />)}
          </FormItem>
          <FormItem
          ...
          >
            {getFieldDecorator('endPoint', {
              ...
              initialValue: tableRecord.endPoint ? tableRecord.endPoint : '',
            })(<Input />)}
          </FormItem>
          <FormItem
          ...
          >
            {getFieldDecorator('accessKey', {
              ...
              initialValue: tableRecord.accessKey ? tableRecord.accessKey : '',
            })(<Input />)}
          </FormItem>
          <FormItem
