...
import { statusRender, dateTimeRender } from 'utils/renderer';
...
export default class ListTable extends PureComponent {
  ...
  render() {
    const { messageData = {}, loading, tenantRoleLevel } = this.props;
    const columns = [
      {
      ...
      {
        title: intl.get('hmsg.messageQuery.model.messageQuery.messageTypeCode').d('类型'),
      ...
      {
        title: intl.get('hmsg.messageQuery.model.messageQuery.trxStatusCode').d('状态'),
