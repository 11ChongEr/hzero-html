...
export default class Drawer extends PureComponent {
  ...
  onFormatChange(value) {
    const { paramFormatList } = this.props;
    const formatData = paramFormatList.filter(item => item.value === value);
    this.setState({
      paramFormatMeaning: formatData[0].meaning,
    });
  }

  @Bind()
  onTypeChange(value) {
    const { editTypeList } = this.props;
    const editTypeData = editTypeList.filter(item => item.value === value);
    this.setState({
      paramEditTypeMeaning: editTypeData[0].meaning,
    });
  }
  ...
  @Bind()
  saveBtn() {
    const { paramFormatMeaning, paramEditTypeMeaning } = this.state;
        ...
        if (isEmpty(err)) {
          ...
          if (isEmpty(itemData)) {
            ...
            onEditOk({
              ...
              concParamId,
              paramFormatMeaning:
                values.paramFormatCode || values.paramFormatCode === 0
                  ? paramFormatMeaning || itemData.paramFormatMeaning
                  : '',
              paramEditTypeMeaning:
                values.paramEditTypeCode || values.paramEditTypeCode === 0
                  ? paramEditTypeMeaning || itemData.paramEditTypeMeaning
                  : '',
            });
          }
        }
      ...
      >
        <Form>
          ...
          >
            ...
            })(<Input disabled={!!itemData.concParamId && isNumber(itemData.concParamId)} />)}
          </Form.Item>
          <Form.Item
          ...
          >
            {getFieldDecorator('paramFormatCode', {
              ...
              initialValue: itemData.paramFormatMeaning,
            })(
          ...
          >
            {getFieldDecorator('paramEditTypeCode', {
              ...
              initialValue: itemData.paramEditTypeMeaning,
            })(
