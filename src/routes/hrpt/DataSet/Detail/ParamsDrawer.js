...
import { Modal, Form, Input, Select, InputNumber, Row, Col } from 'hzero-ui';
      ...
      >
        <Form>
          <Row type="flex">
            ...
            <Col span={12}>
              <Form.Item
                label={intl.get('hrpt.reportDataSet.model.reportDataSet.dataSource').d('数据来源')}
                {...formLayout}
              >
            ...
            <Col span={24}>
              <Form.Item
                label={intl.get('hrpt.reportDataSet.model.reportDataSet.content').d('内容')}
                labelCol={{ span: 3 }}
                wrapperCol={{ span: 19 }}
              >
                  ...
                  rules: [
                    {
                      ...
                      message: intl.get('hzero.common.validation.notNull', {
                        name: intl.get('hrpt.reportDataSet.model.reportDataSet.content').d('内容'),
                      }),
                    },
                  ],
            ...
            <Col span={12}>
              <Form.Item
                label={intl.get('hrpt.reportDataSet.model.reportDataSet.width').d('数据长度')}
                {...formLayout}
              >
                  ...
                  rules: [
                    {
                      ...
                      message: intl.get('hzero.common.validation.notNull', {
                        name: intl
                          .get('hrpt.reportDataSet.model.reportDataSet.width')
                          .d('数据长度'),
                      }),
                    },
                  ],
                  initialValue: itemData.width ? itemData.width : 100,
                })(<InputNumber min={0} style={{ width: '50%' }} />)}
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
                label={intl.get('hrpt.reportDataSet.model.reportDataSet.height').d('数据高度')}
                {...formLayout}
              >
                  ...
                  rules: [
                    {
                      ...
                      message: intl.get('hzero.common.validation.notNull', {
                        name: intl
                          .get('hrpt.reportDataSet.model.reportDataSet.height')
                          .d('数据高度'),
                      }),
                    },
                  ],
                  initialValue: itemData.height ? itemData.height : 25,
                })(<InputNumber min={0} style={{ width: '50%' }} />)}
              </Form.Item>
            </Col>
            <Col span={12}>
