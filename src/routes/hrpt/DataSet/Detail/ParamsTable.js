...
export default class ParamsTable extends PureComponent {
  ...
  render() {
    ...
    const columns = [
      {
        title: intl.get('hrpt.reportDataSet.model.reportDataSet.ordinal').d('序号'),
        dataIndex: 'ordinal',
        width: 60,
      },
      {
      ...
      {
        title: intl.get('hrpt.reportDataSet.model.reportDataSet.dataSource').d('数据来源'),
      ...
      {
        title: intl.get('hrpt.reportDataSet.model.reportDataSet.width').d('数据长度'),
        dataIndex: 'width',
        width: 100,
      },
      {
        title: intl.get('hrpt.reportDataSet.model.reportDataSet.height').d('数据高度'),
        dataIndex: 'height',
        width: 100,
      },
      {
