...
export default class JobGroupForm extends React.PureComponent {
  ...
  render() {
    ...
    return (
      <Modal
        destroyOnClose
        title={intl.get('hrpt.reportRequest.model.reportRequest.detail').d('详情')}
        visible={visible}
      ...
      >
        <Spin spinning={fetchRequestDetailLoading}>
          ...
          <Form.Item
            label={intl.get('hrpt.reportRequest.model.reportRequest.reportCode').d('报表代码')}
            {...formLayout}
          >
          ...
          <Form.Item
            label={intl.get('hrpt.reportRequest.model.reportRequest.reportName').d('报表名称')}
            {...formLayout}
          >
          ...
          <Form.Item
            label={intl.get('hrpt.reportRequest.model.reportRequest.requestStatus').d('运行状态')}
            {...formLayout}
          >
