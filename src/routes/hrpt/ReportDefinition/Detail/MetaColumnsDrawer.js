    ...
    const ordinalRules = [
      {
        ...
        message: intl.get('hzero.common.validation.notNull', {
          name: intl.get('hrpt.reportDefinition.model.reportDefinition.ordinal').d('序号'),
        }),
      },
    ];
      ...
      >
        <Form>
          <Row type="flex">
            <Col span={12}>
              <Form.Item
                label={intl.get('hrpt.reportDefinition.model.reportDefinition.ordinal').d('序号')}
                {...formLayout}
              >
            ...
            <Col span={12}>
              <Form.Item
                label={intl.get('hrpt.reportDefinition.model.reportDefinition.extension').d('小计')}
                {...formLayout}
              >
                {getFieldDecorator('extension', {
                  initialValue: isEmpty(itemData) ? 1 : itemData.extension,
                })(<Switch />)}
              </Form.Item>
            </Col>
            <Col span={12}>
