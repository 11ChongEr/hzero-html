...
import { valueMapMeaning, yesOrNoRender } from 'utils/renderer';
...
export default class MetaColumnsTable extends Component {
  ...
  render() {
    ...
    const columns = [
      {
        title: intl.get('hrpt.reportDefinition.model.reportDefinition.ordinal').d('序号'),
        dataIndex: 'ordinal',
        width: 60,
      },
      {
      ...
      },
      {
        ...
        children: [
          {
            title: intl.get('hrpt.reportDefinition.model.reportDefinition.extension').d('小计'),
            dataIndex: 'extension',
            width: 80,
