...
import { Form, Select, InputNumber, DatePicker, Modal } from 'hzero-ui';
  ...
  render() {
    ...
    return (
      ...
      >
            ...
            rules: [
              {
                ...
                message: intl.get('hzero.common.validation.notNull', {
                  name: intl.get('hsdr.concRequest.model.concRequest.intervalType').d('间隔类型'),
                }),
              },
            ],
          })(
            ...
            rules: [
              {
                required: true,
                message: intl.get('hzero.common.validation.notNull', {
                  name: intl.get('hsdr.concRequest.model.concRequest.intervalNumber').d('间隔大小'),
                }),
              },
            ],
        ...
        <Form.Item
          {...formLayout}
          label={intl.get('hsdr.concRequest.model.concRequest.intervalMinute').d('固定间隔-分')}
        >
        ...
        <Form.Item
          {...formLayout}
          label={intl.get('hsdr.concRequest.model.concRequest.intervalSecond').d('固定间隔-秒')}
        >
