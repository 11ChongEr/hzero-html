...
@formatterCollections({
  code: ['hwfl.monitor', 'hwfl.common', 'entity.position', 'entity.department'],
})
...
export default class Detail extends Component {
  ...
  render() {
    const {
      ...
      tenantId,
      match,
      monitor: { detail = {}, forecast = [], uselessParam },
    } = this.props;
    ...
    return (
      <Fragment>
        <Header title={intl.get('hwfl.common.model.process.detail').d('流程明细')} />
        <Content>
