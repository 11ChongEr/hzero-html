...
export default class Drawer extends PureComponent {
  ...
  searchLeftOperand(parameterType) {
    ...
    if (parameterType !== 'service') {
      dispatch({
        type: 'approveWay/fetchVariableOperand',
      ...
      dispatch({
        type: 'approveWay/fetchServiceOperand',
        payload: { tenantId },
      }).then(res => {
        if (res) {
          this.setState({
  ...
  render() {
    ...
    return (
      ...
      >
        <Form>
          <Form.Item label={intl.get('hwfl.common.model.rule.code').d('规则编码')} {...formLayout}>
                      ...
                      rules: [
                        {
                          ...
                          message: intl.get('hzero.common.validation.notNull', {
                            name: intl.get('hwfl.approveWay.model.rule.code').d('规则编号'),
                          }),
                        },
                      ],
                    },
