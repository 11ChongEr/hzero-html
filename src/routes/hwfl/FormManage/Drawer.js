  ...
  render() {
    ...
    return (
      <Modal
        ...
        title={
          isCreate
            ? intl.get('hwfl.formManage.view.message.create').d('新建表单管理')
            : intl.get('hwfl.formManage.view.message.edit').d('编辑表单管理')
        }
        visible={visible}
        onCancel={onCancel}
        onOk={this.onOk}
      ...
      >
        <Form>
          <FormItem
            label={intl.get('hwfl.formManage.model.formManage.code').d('表单编码')}
            {...formLayout}
          >
              ...
              rules: [
                {
                  ...
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get('hwfl.formManage.model.formManage.code').d('表单编码'),
                  }),
                },
                {
          ...
          >
            {getFieldDecorator('category', {
              ...
              //     message: intl.get('hzero.common.validation.notNull', {
              //       name: intl
              //         .get('hwfl.formManage.model.formManage.category')
              //         .d('流程分类'),
              //     }),
              //   },
              // ],
          ...
          <FormItem
            label={intl.get('hwfl.formManage.model.formManage.url').d('表单url')}
            {...formLayout}
          >
              ...
              rules: [
                {
                  required: true,
                  message: intl.get('hzero.common.validation.notNull', {
                    name: intl.get('hwfl.formManage.model.formManage.url').d('表单url'),
                  }),
                },
              ],
          ...
          <FormItem
            label={intl.get('hwfl.formManage.model.formManage.invokeFlag').d('是否回调')}
            {...formLayout}
          >
