...
import { processStatusRender, readFlagRender, dateTimeRender } from 'utils/renderer';
...
export default class ListTable extends PureComponent {
  ...
  render() {
    ...
    const columns = [
      ...
      {
        title: intl.get('hwfl.carbonCopyTask.model.carbonCopyTask.startTime').d('创建时间'),
        dataIndex: 'startTime',
        width: 150,
        render: dateTimeRender,
      },
      {
        title: intl.get('hwfl.carbonCopyTask.model.carbonCopyTask.endTime').d('结束时间'),
        dataIndex: 'endTime',
        width: 150,
        render: dateTimeRender,
      },
      {
        title: intl.get('hwfl.carbonCopyTask.model.carbonCopyTask.readFlag').d('状态'),
        dataIndex: 'readFlag',
        width: 100,
