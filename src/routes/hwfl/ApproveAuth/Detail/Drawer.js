...
export default class Drawer extends PureComponent {
  ...
  searchLeftOperand(parameterType) {
    ...
    if (parameterType !== 'service') {
      dispatch({
        type: 'approveAuth/fetchVariableOperand',
      ...
      dispatch({
        type: 'approveAuth/fetchServiceOperand',
        payload: { tenantId },
      }).then(res => {
        if (res) {
          this.setState({
  ...
  render() {
    ...
    return (
      ...
      >
        <Form>
          <Form.Item
            label={intl.get('hwfl.approveAuth.model.rule.code').d('规则编号')}
            {...formLayout}
          >
                      ...
                      rules: [
                        {
                          ...
                          message: intl.get('hzero.common.validation.notNull', {
                            name: intl.get('hwfl.approveAuth.model.rule.code').d('规则编号'),
                          }),
                        },
                      ],
                    },
