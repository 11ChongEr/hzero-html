...
export default class Drawer extends PureComponent {
  ...
  onOk() {
    ...
    const { uploadConfigId, objectVersionNumber, _token } = tableRecord;
  ...
  render() {
    ...
    const { bucketName } = tableRecord;
    const { getFieldDecorator } = this.props.form;
    const fileMaxUnitSelector = getFieldDecorator('storageUnit', {
      initialValue: tableRecord.storageUnit ? tableRecord.storageUnit : 'MB',
    })(
        ...
        <Form>
            ...
            {getFieldDecorator('bucketName', {
              rules: [
                ...
                },
                {
                  pattern: /^[a-z0-9-]*$/,
                  message: intl
                    .get('hfile.fileUpload.view.message.bucketName.validate')
                    .d('以小写字母和中划线组成'),
                },
              ],
          ...
          >
            {getFieldDecorator('directory', {
              initialValue: tableRecord ? tableRecord.directory : '',
            })(<Input disabled={!isCreate} />)}
          </FormItem>
          <FormItem
          ...
          >
            {getFieldDecorator('contentType', {
              ...
              initialValue: isEmpty(tableRecord.contentType)
                ? []
                : tableRecord.contentType.split(','),
            })(
          ...
          >
            {getFieldDecorator('fileFormat', {
              ...
              initialValue: isEmpty(tableRecord.fileFormat)
                ? []
                : tableRecord.fileFormat.split(','),
            })(
          ...
          >
            {getFieldDecorator('storageSize', {
              ...
              initialValue: tableRecord ? tableRecord.storageSize : '',
