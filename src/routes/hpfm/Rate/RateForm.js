...
import { Form, Input, DatePicker, Modal } from 'hzero-ui';
import moment from 'moment';
import { round, multiply, isEmpty } from 'lodash';
      ...
      >
        <Form>
          ...
          {form.getFieldValue('rateTypeCode') === 'Current Rate' ? (
            <FormItem {...formLayout} label={intl.get('hpfm.rate.model.rate.rateValue').d('汇率')}>
