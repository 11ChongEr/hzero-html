...
export default class CardTenantEditModal extends React.Component {
  ...
  render() {
    const { modalProps, confirmLoading, fetchCardTenantsLoading, currentRecord = {} } = this.props;
      ...
      >
        ...
        <div className="table-list-operator">
          <Button
            ...
            disabled={currentRecord.enabledFlag === 0}
          >
          ...
          <Button
            key="remove"
            icon="delete"
            disabled={currentRecord.enabledFlag === 0 || rowSelection.selectedRowKeys.length === 0}
