...
import { Table, Modal, Form, Button, Input } from 'hzero-ui';
...
import { filterNullValueObject, addItemsToPagination } from 'utils/utils';
...
export default class ModalCardTable extends Component {
  ...
  handleSearchCard(page = {}) {
    const { dispatch, form, excludeCardIds = [] } = this.props;
