...
import { Form, Input, Button, Modal, Table, Col, Row } from 'hzero-ui';
        ...
        {currentLevel !== 0 && (
          <div>
            <FormItem
              {...formLayout}
              label={intl
                .get('hpfm.industryCategory.model.industryCategory.industryCode.top')
                .d('一级行业代码')}
            >
            ...
            <FormItem
              {...formLayout}
              label={intl
                .get('hpfm.industryCategory.model.industryCategory.industryName.top')
                .d('一级行业名称')}
            >
        ...
        {(currentLevel === 2 || currentLevel === 3) && (
          <div>
            <FormItem
              {...formLayout}
              label={intl
                .get('hpfm.industryCategory.model.industryCategory.industryCode.second')
                .d('二级行业代码')}
            >
                    ...
                    ? [
                        {
                          ...
                          message: intl.get('hzero.common.validation.notNull', {
                            name: intl
                              .get(
                                'hpfm.industryCategory.model.industryCategory.industryCode.second'
                              )
                              .d('二级行业代码'),
                          }),
                        },
            ...
            <FormItem
              {...formLayout}
              label={intl
                .get('hpfm.industryCategory.model.industryCategory.industryName.second')
                .d('二级行业名称')}
            >
                    ...
                    ? [
                        {
                          ...
                          message: intl.get('hzero.common.validation.notNull', {
                            name: intl
                              .get(
                                'hpfm.industryCategory.model.industryCategory.industryName.second'
                              )
                              .d('二级行业名称'),
                          }),
                        },
        ...
        {currentLevel === 3 && (
          <div>
            ...
            >
              ...
              })(<Input typeCase="upper" trim inputChinese={false} disabled={!!categoryCode} />)}
            </FormItem>
            <FormItem
              {...formLayout}
              label={intl
...
export default class IndustryCategory extends PureComponent {
  /**
   * 内部状态
   */
  state = {
  ...
  render() {
    ...
    const topColumns = [
      ...
      },
      {
        ...
        render: (_, record) => {
          return (
            <a onClick={() => this.handleModal(true, 1, record)}>
    ...
    const secondColumns = [
      ...
      },
      {
        ...
        render: (_, record) => {
          return (
            <a onClick={() => this.handleModal(true, 2, record)}>
              {intl.get('hzero.common.button.edit').d('编辑')}
            </a>
          );
        },
    ...
    const categoryColumns = [
      ...
      },
      {
        ...
        render: (_, record) => {
          return (
            <a onClick={() => this.handleModal(true, 3, record)}>
              {intl.get('hzero.common.button.edit').d('编辑')}
            </a>
          );
        },
    ...
    return (
      <React.Fragment>
        <Header title={intl.get('hpfm.industryCategory.view.message.title').d('国标品类')} />
        <Content>
          <Row gutter={24}>
