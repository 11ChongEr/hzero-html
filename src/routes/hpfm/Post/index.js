...
export default class Post extends Component {
   ...
   */
  render() {
    const { loading, saveLoading, editLoading, post = {} } = this.props;
    const { unitCode, unitName, renderTree = [], expandedRowKeys = [] } = post;
    const { activePostData = {}, drawerVisible = false } = this.state;
    const filterProps = {
      unitCode,
      unitName,
    ...
    const listProps = {
      ...
      showSubLine: this.handleExpandSubLine,
    ...
    return (
      <Fragment>
        ...
        >
          ...
          <Button icon="plus" onClick={this.handleAddPost}>
