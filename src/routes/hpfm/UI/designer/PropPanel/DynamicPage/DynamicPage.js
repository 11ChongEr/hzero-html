...
export default class DynamicPage extends React.Component {
  ...
  render() {
    ...
    return (
      <Form>
        <Form.Item className="ant-form-item-without-help">页面编码: {config.pageCode}</Form.Item>
        <Form.Item className="ant-form-item-without-help">页面描述: {config.description}</Form.Item>
