...
export default class FilterForm extends PureComponent {
  ...
  render() {
    ...
    return (
      <Fragment>
        <Form layout="inline">
          <Form.Item label={intl.get('hpfm.calendar.model.calendar.calendarName').d('描述')}>
            {getFieldDecorator('calendarName', {})(<Input />)}
          </Form.Item>
          <Form.Item label={intl.get('hpfm.calendar.model.calendar.country').d('国家/地区')}>
            {getFieldDecorator('countryId', {})(
              <Lov code="HPFM.COUNTRY" textField="countryName" />
            )}
          </Form.Item>
          <Form.Item>
