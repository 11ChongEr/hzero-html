...
export default class BankForm extends ModalForm {
  renderForm() {
    ...
    return (
      <React.Fragment>
        <Form.Item {...formLayout} label={intl.get('hpfm.bank.model.bank.bankCode').d('银行代码')}>
          ...
          })(<Input inputChinese={false} disabled={!!data.bankId} />)}
        </Form.Item>
        <Form.Item {...formLayout} label={intl.get('hpfm.bank.model.bank.bankType').d('银行类型')}>
        ...
        <Form.Item {...formLayout} label={intl.get('hpfm.bank.model.bank.bankName').d('银行名称')}>
        ...
        <Form.Item {...formLayout} label={intl.get('hzero.common.status.enable')}>
