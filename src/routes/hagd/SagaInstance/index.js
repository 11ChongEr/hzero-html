...
import { Tabs, Row, Col, Button } from 'hzero-ui';
        ...
        <Content>
          <Row style={{ marginBottom: 10 }}>
            <Row type="flex" justify="end">
              <Col>
                <h3 style={{ width: 360, textAlign: 'left' }}>事务实例状态总览</h3>
              </Col>
            </Row>
            <Row type="flex" justify="end">
              <Col>
                <InstanceStatus value={COMPLETED} text="完成" status="completed" />
              </Col>
              <Col>
                <InstanceStatus value={RUNNING} text="运行中" status="running" />
              </Col>
              <Col>
                <InstanceStatus value={FAILED} text="失败" status="failed" />
              </Col>
            </Row>
          </Row>
          <Tabs defaultActiveKey="saga" type="card" onChange={this.handleTabChange}>
            <Tabs.TabPane tab="事务" key="saga">
              <SagaFilter
            ...
            <Tabs.TabPane tab="任务" key="task">
              ...
              <TaskTable
                loading={fetchTaskLoading || refreshLoading}
                showDetail={this.handleShowDetail}
          ...
          <Drawer
            title={`${sagaInstanceRunDetail.id}-事务实例详情`}
