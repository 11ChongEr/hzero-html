...
export async function fetchServiceConfigList(params) {
  return request(`${HZERO_HCNF}/v1/${configApi()}`, {
    method: 'GET',
    query: params,
  });
}
...
export async function fetchServiceConfigDetail(params) {
  return request(`${HZERO_HCNF}/v1/${configApi()}/${params.serviceConfigId}`, {
    method: 'GET',
  });
}
...
export async function refreshServiceConfig(params) {
  return request(`${HZERO_HCNF}/v1/monitor/${params.serviceConfigId}/refresh-config`, {
    method: 'POST',
    body: params,
  });
}
