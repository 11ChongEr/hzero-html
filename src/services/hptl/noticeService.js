...
import { HZERO_PTL, HZERO_FILE, HZERO_PLATFORM, VERSION_IS_OP } from 'utils/config';
...
export async function fetchNotice(params) {
  ...
  return request(prefixUrl(HZERO_PTL, 'notices'), {
    method: 'GET',
    query: other,
  });
}
...
export async function queryNotice(params) {
  return request(prefixUrl(HZERO_PTL, `notices/${params.noticeId}`), {
    method: 'GET',
  });
}
...
export async function publicNotice(params) {
  return request(prefixUrl(HZERO_PTL, `notices/${params.noticeId}/publish`), {
    method: 'POST',
    query: params,
  });
}
...
export async function revokeNotice(params) {
  return request(prefixUrl(HZERO_PTL, `notices/${params.noticeId}/revoke`), {
    method: 'POST',
    body: params.record,
  });
}
