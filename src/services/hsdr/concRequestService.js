 ...
 * 再次执行
 * @async
 * @function againTrigger
 * @param {String} params.enabledFlag - 是否启用
 */
export async function againTrigger(params) {
  return request(
    organizationRoleLevel
      ? `${HZERO_SDR}/v1/${organizationId}/concurrent-requests/${params.requestId}/again`
      : `${HZERO_SDR}/v1/concurrent-requests/${params.requestId}/again`,
    {
      method: 'POST',
    }
  );
